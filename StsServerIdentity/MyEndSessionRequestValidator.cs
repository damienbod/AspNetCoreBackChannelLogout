...
namespace IdentityServer4.Validation
{
    ...
    /// </summary>
    public class MyEndSessionRequestValidator : IEndSessionRequestValidator
    {
        /// <summary>
        /// The logger.
        /// </summary>
        ...
        public MyEndSessionRequestValidator(
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            Logger = loggerFactory.CreateLogger<MyEndSessionRequestValidator>();
        }
        ...
        protected virtual EndSessionValidationResult Invalid(string message, ValidatedEndSessionRequest request = null)
        {
            ...
            if (request != null)
            {
                ...
                {
                    Logger.LogDebug(message + Environment.NewLine + $"{cid}");
                }
            }
            else
            {
